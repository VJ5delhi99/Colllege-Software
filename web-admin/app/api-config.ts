const defaults = {
  ...
  NEXT_PUBLIC_ORGANIZATION_API_URL: "http://localhost:7018",
  ...
  NEXT_PUBLIC_LMS_API_URL: "http://localhost:7013",
...
export const apiConfig = {
  ...
  organization: () => getEnv("NEXT_PUBLIC_ORGANIZATION_API_URL"),
  ...
  lms: () => getEnv("NEXT_PUBLIC_LMS_API_URL"),
